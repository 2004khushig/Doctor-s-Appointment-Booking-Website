...
const DoctorCard = ({ doctor }) => {
    ...
    return (
        <div className='p-3 lg:p-5'>
            ...
            <div className='mt-2 lg:mt-4flex items-center justify-between'>
                ...
                <div className='flex items-center gap-[300px] mt-3'>
                    <span className='flex items-center gap-[6px] text-[14px] leading-6 lg:text-[16px] lg:leading-7 font-semiboldtext-headingColor'>
            ...
            <div className='mt-[18px] lg:mt-1 flex items-center justify-between'>
                <div>
                    ...
                    <p className='text-[14px] leading-6 font-[400] text-textColor'>At {experience && experience[0]?.hospital}</p>
                </div>
